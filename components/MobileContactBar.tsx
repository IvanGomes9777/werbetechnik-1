...
/**
 * Persistente Schnellkontakt-Leiste am unteren Rand.
 * Sichtbar bis `xl` — ab `xl` übernimmt der Navbar-CTA „Beratung anfragen".
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-[60] grid grid-cols-2 border-t border-line bg-noir/95 pb-[env(safe-area-inset-bottom)] backdrop-blur-md xl:hidden">
      <a
        ...
        className="flex items-center justify-center gap-2.5 py-3.5 text-sm font-medium text-[#f2f0e6] bg-olive transition-colors hover:bg-olive-bright"
      >
